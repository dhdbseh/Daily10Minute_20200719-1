...
class ProofAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val userNickNameTxt = row.findViewById<ImageView>(R.id.userNickNameTxt)
        val proofTimeTxt = row.findViewById<ImageView>(R.id.proofTimeTxt)
        val contentTxt = row.findViewById<ImageView>(R.id.contentTxt)
